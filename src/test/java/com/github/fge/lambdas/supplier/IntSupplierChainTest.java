...
public final class IntSupplierChainTest
    extends ChainTest<IntSupplier, ThrowingIntSupplier, IntSupplierChain, Integer>
{
    public IntSupplierChainTest()
    {
        super(42, 24);
    }
    ...
    @Override
    protected IntSupplierChain getChain(
