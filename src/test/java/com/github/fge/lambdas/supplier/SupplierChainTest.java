...
public final class SupplierChainTest
    extends ChainTest<Supplier<Type1>, ThrowingSupplier<Type1>, SupplierChain<Type1>, Type1>
{
    public SupplierChainTest()
    {
    ...
    @Override
    protected SupplierChain<Type1> getChain(
