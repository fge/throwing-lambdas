...
public final class DoubleSupplierChainTest
    extends ChainTest<DoubleSupplier, ThrowingDoubleSupplier, DoubleSupplierChain, Double>
{
    public DoubleSupplierChainTest()
    {
        super(42.0, 24.0);
    }
    ...
    @Override
    protected DoubleSupplierChain getChain(
