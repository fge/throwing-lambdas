...
public final class LongSupplierChainTest
    extends ChainTest<LongSupplier, ThrowingLongSupplier, LongSupplierChain, Long>
{
    public LongSupplierChainTest()
    {
        super(42L, 24L);
    }
    ...
    @Override
    protected LongSupplierChain getChain(
