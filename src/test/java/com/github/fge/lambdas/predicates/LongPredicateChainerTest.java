...
public final class LongPredicateChainerTest
    extends ChainerTest<LongPredicate, ThrowingLongPredicate, LongPredicateChainer, Boolean>
{
    private final long value = 1L;

    public LongPredicateChainerTest()
    {
        super(true, false);
    }
    ...
    @Override
    protected LongPredicateChainer getChain(final ThrowingLongPredicate throwing)
    {
