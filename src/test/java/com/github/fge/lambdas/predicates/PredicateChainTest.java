...
public final class PredicateChainTest
    extends ChainTest<Predicate<Type1>, ThrowingPredicate<Type1>, PredicateChain<Type1>, Boolean>
{
    private final Type1 t = Type1.mock();

    public PredicateChainTest()
    {
        super(true, false);
    }
    ...
    @Override
    protected PredicateChain<Type1> getChain(
