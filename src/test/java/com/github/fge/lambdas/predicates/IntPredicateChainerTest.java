...
public final class IntPredicateChainerTest
    extends ChainerTest<IntPredicate, ThrowingIntPredicate, IntPredicateChainer, Boolean>
{
    private final int value = 1;

    public IntPredicateChainerTest()
    {
        super(true, false);
    }
    ...
    @Override
    protected IntPredicateChainer getChain(final ThrowingIntPredicate throwing)
    {
