...
public final class DoublePredicateChainerTest
    extends ChainerTest<DoublePredicate, ThrowingDoublePredicate, DoublePredicateChainer, Boolean>
{
    private final double value = 1.0;

    public DoublePredicateChainerTest()
    {
        super(true, false);
    }
    ...
    @Override
    protected DoublePredicateChainer getChain(final ThrowingDoublePredicate throwing)
    {
