...
public final class ObjDoubleConsumerChainerTest
    extends ChainerTest<ObjDoubleConsumer<Type1>, ThrowingObjDoubleConsumer<Type1>, ObjDoubleConsumerChainer<Type1>, Type2>
{
    ...
    public ObjDoubleConsumerChainerTest()
    {
    ...
    @Override
    protected ObjDoubleConsumerChainer<Type1> getChain(
