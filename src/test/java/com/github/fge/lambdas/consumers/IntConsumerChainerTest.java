...
public final class IntConsumerChainerTest
    extends ChainerTest<IntConsumer, ThrowingIntConsumer, IntConsumerChainer, Type1>
{
    ...
    @Override
    protected IntConsumerChainer getChain(
        final ThrowingIntConsumer throwing)
    {
        return Throwing.intConsumer(throwing);
    }
