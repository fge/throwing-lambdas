...
public final class BiConsumerChainerTest
    extends ChainerTest<BiConsumer<Type1, Type2>, ThrowingBiConsumer<Type1, Type2>, BiConsumerChainer<Type1, Type2>, Type3>
{
    ...
    @Override
    protected BiConsumerChainer<Type1, Type2> getChain(
