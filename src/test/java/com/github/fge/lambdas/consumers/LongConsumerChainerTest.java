...
public final class LongConsumerChainerTest
    extends ChainerTest<LongConsumer, ThrowingLongConsumer, LongConsumerChainer, Type1>
{
    ...
    public LongConsumerChainerTest()
    {
    ...
    @Override
    protected LongConsumerChainer getChain(
