...
public final class DoubleConsumerChainerTest
    extends ChainerTest<DoubleConsumer, ThrowingDoubleConsumer, DoubleConsumerChainer, Type1>
{
    ...
    public DoubleConsumerChainerTest()
    {
    ...
    @Override
    protected DoubleConsumerChainer getChain(
        final ThrowingDoubleConsumer throwing)
    {
        return Throwing.doubleConsumer(throwing);
    }
