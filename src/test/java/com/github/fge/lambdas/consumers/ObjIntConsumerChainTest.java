...
public final class ObjIntConsumerChainTest
    extends ChainTest<ObjIntConsumer<Type1>, ThrowingObjIntConsumer<Type1>, ObjIntConsumerChain<Type1>, Type2>
{
    ...
    public ObjIntConsumerChainTest()
    {
