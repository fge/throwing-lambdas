...
public final class IntBinaryOperatorChainerTest
    extends ChainerTest<IntBinaryOperator, ThrowingIntBinaryOperator, IntBinaryOperatorChainer, Integer>
{
    private final int left = 1;
    private final int right = 2;

    public IntBinaryOperatorChainerTest()
    {
        super(42, 24);
    }
    ...
    @Override
    protected IntBinaryOperatorChainer getChain(
