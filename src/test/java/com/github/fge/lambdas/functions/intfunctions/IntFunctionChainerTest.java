...
public final class IntFunctionChainerTest
    extends ChainerTest<IntFunction<Type1>, ThrowingIntFunction<Type1>, IntFunctionChainer<Type1>, Type1>
{
    private final int value = 42;

    public IntFunctionChainerTest()
    {
    ...
    @Override
    protected IntFunctionChainer<Type1> getChain(
