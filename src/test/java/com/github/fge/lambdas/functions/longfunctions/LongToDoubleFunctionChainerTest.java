...
public final class LongToDoubleFunctionChainerTest
    extends ChainerTest<LongToDoubleFunction, ThrowingLongToDoubleFunction, LongToDoubleFunctionChainer, Double>
{
    private final long value = 42L;

    public LongToDoubleFunctionChainerTest()
    {
        super(42.0, 24.0);
    }
    ...
    @Override
    protected LongToDoubleFunctionChainer getChain(
