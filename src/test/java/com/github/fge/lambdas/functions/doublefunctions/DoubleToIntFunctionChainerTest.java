...
public final class DoubleToIntFunctionChainerTest
    extends ChainerTest<DoubleToIntFunction, ThrowingDoubleToIntFunction, DoubleToIntFunctionChainer, Integer>
{
    private final double value = 42.0;

    public DoubleToIntFunctionChainerTest()
    {
        super(42, 24);
    }
    ...
    @Override
    protected DoubleToIntFunctionChainer getChain(
