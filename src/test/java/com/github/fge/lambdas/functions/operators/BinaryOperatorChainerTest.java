...
public final class BinaryOperatorChainerTest
    extends ChainerTest<BinaryOperator<Type1>, ThrowingBinaryOperator<Type1>, BinaryOperatorChainer<Type1>, Type1>
{
    private final Type1 t = Type1.mock();
    private final Type1 u = Type1.mock();

    public BinaryOperatorChainerTest()
    {
    ...
    @Override
    protected BinaryOperatorChainer<Type1> getChain(
