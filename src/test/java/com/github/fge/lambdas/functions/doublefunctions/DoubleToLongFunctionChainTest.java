...
public final class DoubleToLongFunctionChainTest
    extends ChainTest<DoubleToLongFunction, ThrowingDoubleToLongFunction, DoubleToLongFunctionChain, Long>
{
    private final double value = 42.0;

    public DoubleToLongFunctionChainTest()
    {
        super(42L, 24L);
    }
    ...
    @Override
    protected DoubleToLongFunctionChain getChain(
