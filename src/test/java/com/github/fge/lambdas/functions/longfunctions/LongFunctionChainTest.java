...
public final class LongFunctionChainTest
    extends ChainTest<LongFunction<Type1>, ThrowingLongFunction<Type1>, LongFunctionChain<Type1>, Type1>
{
    private final long value = 42L;

    public LongFunctionChainTest()
    {
    ...
    @Override
    protected LongFunctionChain<Type1> getChain(
