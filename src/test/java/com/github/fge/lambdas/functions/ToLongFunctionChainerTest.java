...
public final class ToLongFunctionChainerTest
    extends ChainerTest<ToLongFunction<Type1>, ThrowingToLongFunction<Type1>, ToLongFunctionChainer<Type1>, Long>
{
    private final Type1 value = Type1.mock();

    public ToLongFunctionChainerTest()
    {
        super(42L, 24L);
    }
    ...
    @Override
    protected ToLongFunctionChainer<Type1> getChain(
