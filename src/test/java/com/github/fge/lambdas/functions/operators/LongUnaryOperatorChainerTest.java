...
public final class LongUnaryOperatorChainerTest
    extends ChainerTest<LongUnaryOperator, ThrowingLongUnaryOperator, LongUnaryOperatorChainer, Long>
{
    private final long operand = 1L;

    public LongUnaryOperatorChainerTest()
    {
        super(42L, 24L);
    }
    ...
    @Override
    protected LongUnaryOperatorChainer getChain(
