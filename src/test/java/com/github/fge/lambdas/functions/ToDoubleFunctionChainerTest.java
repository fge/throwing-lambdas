...
public final class ToDoubleFunctionChainerTest
    extends ChainerTest<ToDoubleFunction<Type1>, ThrowingToDoubleFunction<Type1>, ToDoubleFunctionChainer<Type1>, Double>
{
    private final Type1 value = Type1.mock();

    public ToDoubleFunctionChainerTest()
    {
        super(42.0, 24.0);
    }
    ...
    @Override
    protected ToDoubleFunctionChainer<Type1> getChain(
