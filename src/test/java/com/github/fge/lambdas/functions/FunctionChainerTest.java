...
public final class FunctionChainerTest
    extends ChainerTest<Function<Type1, Type2>, ThrowingFunction<Type1, Type2>,
        FunctionChainer<Type1, Type2>, Type2>
{
    private final Type1 t = Type1.mock();


    public FunctionChainerTest()
    ...
    @Override
    protected FunctionChainer<Type1, Type2> getChain(
