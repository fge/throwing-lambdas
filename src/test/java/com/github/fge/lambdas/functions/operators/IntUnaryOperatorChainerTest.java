...
public final class IntUnaryOperatorChainerTest
    extends ChainerTest<IntUnaryOperator, ThrowingIntUnaryOperator, IntUnaryOperatorChainer, Integer>
{
    private final int operand = 1;

    public IntUnaryOperatorChainerTest()
    {
        super(42, 24);
    }
    ...
    @Override
    protected IntUnaryOperatorChainer getChain(
