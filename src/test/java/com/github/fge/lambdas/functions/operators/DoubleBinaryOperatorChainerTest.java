...
public final class DoubleBinaryOperatorChainerTest
    extends ChainerTest<DoubleBinaryOperator, ThrowingDoubleBinaryOperator, DoubleBinaryOperatorChainer, Double>
{
    private final double left = 1.0;
    private final double right = 2.0;

    public DoubleBinaryOperatorChainerTest()
    {
        super(42.0, 24.0);
    }
    ...
    @Override
    protected DoubleBinaryOperatorChainer getChain(
