...
public final class DoubleFunctionChainerTest
    extends ChainerTest<DoubleFunction<Type1>, ThrowingDoubleFunction<Type1>, DoubleFunctionChainer<Type1>, Type1>
{
    private final double value = 42.0;

    public DoubleFunctionChainerTest()
    {
    ...
    @Override
    protected DoubleFunctionChainer<Type1> getChain(
