...
public final class BiFunctionChainerTest
    extends ChainerTest<BiFunction<Type1, Type2, Type3>, ThrowingBiFunction<Type1, Type2, Type3>, BiFunctionChainer<Type1, Type2, Type3>, Type3>
{
    private final Type1 t = Type1.mock();
    private final Type2 u = Type2.mock();

    public BiFunctionChainerTest()
    {
    ...
    @Override
    protected BiFunctionChainer<Type1, Type2, Type3> getChain(
