...
public final class ToIntFunctionChainTest
    extends ChainTest<ToIntFunction<Type1>, ThrowingToIntFunction<Type1>, ToIntFunctionChain<Type1>, Integer>
{
    private final Type1 value = Type1.mock();

    public ToIntFunctionChainTest()
    {
        super(42, 24);
    }
    ...
    @Override
    protected ToIntFunctionChain<Type1> getChain(
