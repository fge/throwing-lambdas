...
public final class LongBinaryOperatorChainTest
    extends ChainTest<LongBinaryOperator, ThrowingLongBinaryOperator, LongBinaryOperatorChain, Long>
{
    private final long left = 1L;
    private final long right = 2L;

    public LongBinaryOperatorChainTest()
    {
        super(42L, 24L);
    }
    ...
    @Override
    protected LongBinaryOperatorChain getChain(
